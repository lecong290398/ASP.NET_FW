...
namespace AtTempleteWeb_API.Context
{
    public partial class AtTempleteWebContext : DbContext
    {
        public AtTempleteWebContext()
        {
        }

        public AtTempleteWebContext(DbContextOptions<AtTempleteWebContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<MSC_AudittingLog> MSC_AudittingLog { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=101.99.32.48,9899;Database=AtTempleteWeb;User Id=sa;Password=1@qweQAZ");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Code>(entity =>
            {
                entity.HasKey(e => e.KeyCode)
                    .HasName("PK__Code__5B86B6EE89D892E3");
            ...
            modelBuilder.Entity<MSC_AudittingLog>(entity =>
            {
